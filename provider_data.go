	...
	for name, attr := range attrs {
		...
		case schema.BoolAttribute:
			info = SchemaInfo{
				...
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Bool) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.Float32Attribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Float32) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.Float64Attribute:
			info = SchemaInfo{
				...
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Float64) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.Int32Attribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Int32) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.Int64Attribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Int64) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.NumberAttribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Number) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.StringAttribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.String) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.ListAttribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.List) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.MapAttribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Map) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.SetAttribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Set) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.DynamicAttribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Dynamic) string { return DescriptionCtxOf(ctx, v) }),
		...
		case schema.ObjectAttribute:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(attr),
				Deprecation:              attr.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(attr.PlanModifiers, func(v planmodifier.Object) string { return DescriptionCtxOf(ctx, v) }),
...
func (pd ProviderData) newResourceNestedAttrObjectInfos(ctx context.Context, parents []string, obj schema.NestedAttributeObject) (nested NestedSchemaInfos, diags diag.Diagnostics) {
	...
	nested[strings.Join(parents, ".")] = NestedSchemaInfo{
		PlanModifierDescriptions: MapSlice(obj.PlanModifiers, func(v planmodifier.Object) string { return DescriptionCtxOf(ctx, v) }),
		Infos:                    attrInfos,
	}
	maps.Copy(nested, attrNested)
	return
	...
	for name, blk := range blks {
		...
		case schema.SingleNestedBlock:
			info = SchemaInfo{
				...
				PlanModifierDescriptions: MapSlice(blk.PlanModifiers, func(v planmodifier.Object) string { return DescriptionCtxOf(ctx, v) }),
			}
		case schema.ListNestedBlock:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(blk),
				Deprecation:              blk.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(blk.PlanModifiers, func(v planmodifier.List) string { return DescriptionCtxOf(ctx, v) }),
			}
		case schema.SetNestedBlock:
			info = SchemaInfo{
				...
				Description:              DescriptionOf(blk),
				Deprecation:              blk.GetDeprecationMessage(),
				PlanModifierDescriptions: MapSlice(blk.PlanModifiers, func(v planmodifier.Set) string { return DescriptionCtxOf(ctx, v) }),
			}
		}
